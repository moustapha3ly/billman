...
class AuthViewsResource extends PackageResource
{
    ...
    protected $authViewsContent = [
        'login.blade.php'             => '@extends(\auth.login\')',
        'register.blade.php'          => '@extends(\auth.register\')',
        'verify.blade.php'            => '@extends(\auth.verify\')',
        'passwords/confirm.blade.php' => '@extends(\auth.passwords.confirm\')',
        'passwords/email.blade.php'   => '@extends(\auth.passwords.email\')',
        'passwords/reset.blade.php'   => '@extends(\auth.passwords.reset\')',
    ];
